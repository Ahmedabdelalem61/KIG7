...
# Part of Softhealer Technologies.
{
    ...
    'assets': {
        ...
        'web.assets_backend': [
            ...
            'sh_entmate_theme/static/src/js/calculate.js',
        ...
        'web.assets_tests': [
            'sh_entmate_theme/static/tests/tours/sh_entmate_theme_tour_helpers.js',
            'sh_entmate_theme/static/tests/tours/sh_entmate_theme_tours.js',
            'sh_entmate_theme/static/tests/tours/sh_entmate_theme_tours_phase_b.js',
        ],
