...
whenReady(() => {
    ...
    $(document).on("click", "#action_preview_theme_style_1", function () {
        $("#js_id_theme_preview_image").attr(
            "src",
            "sh_back_theme_config/static/src/img/preview/theme/theme_style_img.png"
        );
    });
    ...
    $(".o_web_client").on("click", ".o_action_manager", function () {
